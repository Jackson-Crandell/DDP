...
Q_f = eye(4,4);
Q_f(1,1) = 1000;		%Penalize more w.r.t errors in position
Q_f(2,2) = 1000;
Q_f(3,3) = 1;    	%Penalize less for errors in velocity
Q_f(4,4) = 1;
...
p_target(1,1) = 3;          % x         (position of cart)
